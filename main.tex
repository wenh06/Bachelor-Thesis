...
\documentclass[type=bachelor,fontset=fandol,pifootnote]{thuthesis}
...
\usepackage{tikz-cd}
\usepackage{tikz}
\usetikzlibrary{shapes,arrows.meta,external,decorations.pathmorphing,backgrounds,positioning,fit,petri,calc,hobby}
...
%%% 正文部分
\mainmatter
\include{data/chap01_aut_rep}
\include{data/chap02_langlands}
\include{data/chap03_summary}
